                ...
                <div class="content">
                  <form class="ui form" onSubmit={e => e.preventDefault()}>
                    ...
                    <div className="form-check" style={{ display: "flex", flexDirection: "column", marginBottom: "0.5rem" }}>
                      <div class=" checkbox"><input type="checkbox" tabindex="0" /><label>Amazon</label></div>
                      <div class=" checkbox"><input type="checkbox" tabindex="0" /><label>Flipkart</label></div>
                      <div class=" checkbox"><input type="checkbox" tabindex="0" /><label>Jiomart</label></div>
                      <div class=" checkbox"><input type="checkbox" tabindex="0" /><label>Grofers</label></div>
                      <div class=" checkbox"><input type="checkbox" tabindex="0" /><label>BigBasket</label></div>
                    </div>
